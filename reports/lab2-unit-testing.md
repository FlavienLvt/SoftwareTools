...
**What this coverage helps with:** It allows us to confirm there is no "dead code" and that our exception paths (negative scores or scores over 100) are executed correctly.

**What this coverage does NOT prove:** As discussed in class, coverage close to 100% does not prove the software is perfect. It does not guarantee that the requirements are correct, that usability is good, or that the test data used is relevant.
